...
SDwave_amy <- TEP_amy_avg %>% 
  ...
  summarise(SD = mean(SDchange), se = sd(SDchange)/sqrt(30))
...
normwave_amy <- TEP_amy_avg %>% 
  group_by(Time, Condition) %>%
  summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(30)) %>% 
  filter(Condition != "fake" & Time >=-250 & Time <=500)
p.norm_amy <- normwave_amy %>% ggplot(aes(Time, norm))+
  ...
  xlab("Time (ms)")+
  ylab("Amplitude (SD)")+ ggtitle("AMY  n = 30")+theme_classic()+
  theme(axis.line=element_line(linetype=1,color="black",size=.8))+
  theme(axis.ticks=element_line(color="black",size=.8,lineend = 12))+
  theme(axis.text = element_text(color = "black", size = rel(1.5)))+
  theme(axis.title = element_text(color = "black", size = 18))+
...
p.components_amy <- normwave_amy %>% filter(Time >=-80 & Time <=500) %>% 
  ...
  geom_line(aes(linetype = Condition, size = Condition),col = "dodgerblue2")+
  geom_vline(xintercept=0, linetype="dashed")+
  annotate("rect", xmin=25, xmax=100, ymin=3.2, ymax=3.8, fill="orangered3")+
  annotate("rect", xmin=55, xmax=250, ymin=-4, ymax=-4.6, fill="seagreen4")+
  annotate("rect", xmin=151, xmax=450, ymin=3.2, ymax=3.8, fill="dodgerblue4")+
  annotate("rect", xmin=-12, xmax=28, ymin=-1.5, ymax=1, fill="gray")+
  scale_linetype_manual(values=c("solid","dashed"))+
  scale_size_manual(values=c(1.5,0.8))+
  ylim(-5,4)+
  scale_x_continuous(limits=c(-80,550), breaks = c(0,100,200,300,400,500))+
  scale_y_continuous(limits=c(-5,4), breaks = c(-4,-2,0,2,4))+
...
# Save pdf
filename <- "iTEP_L-DLPFC_AMY_components.pdf"
...
p.norm_me <- normwave_amy_me %>% ggplot(aes(Time, norm))+
  ...
  scale_color_manual(values=c("green4","darkgrey"),labels=c("TMS","Sham"))+
  scale_fill_manual(values=c("green4","darkgrey"),labels=c("TMS","Sham"))+
  scale_y_continuous(limits=c(-8,8), breaks = c(-5,0,5))+scale_x_continuous(limits=c(-300,500), 
                                breaks=c(-300,-200,-100,0,100,200,300,400,500))+
  xlab("Time (ms)")+
...
# left
wave_amy_me_L <- TEP_amy_avg %>% filter(is_lateral == 0 & Condition != "fake" & DKT == "Left-Amygdala" & Time <=500 & Time >= -250) %>% 
...
normwave_amy_me_L <- TEP_amy_avg %>% filter(is_lateral == 0 & Condition != "fake" & DKT == "Left-Amygdala" & Time <=500 & Time >= -250) %>% 
  group_by(Time, Condition) %>% summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(3)) 
...
# right
wave_amy_me_R <- TEP_amy_avg %>% filter(is_lateral == 0 & Condition != "fake" & DKT == "Right-Amygdala" & Time <=500 & Time >= -250) %>% 
...
normwave_amy_me_R <- TEP_amy_avg %>% filter(is_lateral == 0 & Condition != "fake" & DKT == "Right-Amygdala" & Time <=500 & Time >= -250) %>% 
  group_by(Time, Condition) %>% summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(15)) 
...
SDwave_amy_la <- TEP_amy_avg %>% 
  filter(is_lateral == 1 & Condition != "fake" & Time <=500 & Time >= -250) %>% 
  group_by(Condition, Time) %>% 
...
normwave_amy_la <- TEP_amy_avg %>% 
  filter(is_lateral == 1 & Condition != "fake" & Time <=500 & Time >= -250) %>% 
  group_by(Time, Condition) %>% summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(12)) 
...
# left
wave_amy_la_L <- TEP_amy_avg %>% filter(is_lateral == 1 & Condition != "fake" & DKT == "Left-Amygdala" & Time <=500 & Time >= -250) %>% 
...
normwave_amy_la_L <- TEP_amy_avg %>% filter(is_lateral == 1 & Condition != "fake" & DKT == "Left-Amygdala" & Time <=500 & Time >= -250) %>% 
  group_by(Time, Condition) %>% summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(5)) 
...
# right
wave_amy_la_R <- TEP_amy_avg %>% filter(is_lateral == 1 & Condition != "fake" & DKT == "Right-Amygdala" & Time <=500 & Time >= -250) %>% 
...
normwave_amy_la_R <- TEP_amy_avg %>% filter(is_lateral == 1 & Condition != "fake" & DKT == "Right-Amygdala" & Time <=500 & Time >= -250) %>% 
  group_by(Time, Condition) %>% summarise(norm = mean(iTEP_norm), se = sd(iTEP_norm)/sqrt(7)) 
...
p.norm_bi <- normwave_bi %>% ggplot(aes(Time, norm))+
  geom_hline(yintercept=0, linewidth = .4, col = "darkgray")+
  ...
  # FDR
  # annotate("rect", xmin=52, xmax=92, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=194, xmax=217, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=326, xmax=351, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=54, xmax=111, ymin=5.5, ymax=5.8, fill="green4")+
  # annotate("rect", xmin=196, xmax=223, ymin=5.5, ymax=5.8, fill="green4")+
  # annotate("rect", xmin=328, xmax=351, ymin=5.5, ymax=5.8, fill="green4")+
  
  # Cluster
  annotate("rect", xmin=49, xmax=114, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  annotate("rect", xmin=190, xmax=273, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=322, xmax=357, ymin=5.9, ymax=6.2, fill="dodgerblue3", alpha = 0.6)+
  annotate("rect", xmin=50, xmax=117, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=191, xmax=239, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=324, xmax=357, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=211, xmax=257, ymin=5.1, ymax=5.4, fill="maroon3")+
  annotate("rect", xmin=402, xmax=449, ymin=5.1, ymax=5.4, fill="maroon3")+
  ...
  xlab("Time (ms)")+ylab("Amplitude (SD)")+ 
  ggtitle("Bilateral AMY, medial = 18, lateral = 12")+theme_classic()+
  theme(axis.line=element_line(linetype=1,color="black",size=.6))+
  theme(axis.ticks=element_line(color="black",size=.6,lineend = 12))+
  theme(axis.text = element_text(color = "black", size = rel(1.5)))+
  theme(axis.title = element_text(color = "black", size = 18))+
...
filename <- "iTEP_L-DLPFC_AMY_B_corrected.pdf"
pdf(file = filename, height = 4.5, width = 5.5)
p.norm_bi
dev.off()
...
wave_amy_me_L <- wave_amy_me_L %>% mutate(subdivision = "Medial")
wave_amy_la_L <- wave_amy_la_L %>% mutate(subdivision = "Lateral")
normwave_L <- rbind(normwave_amy_L, wave_amy_me_L, wave_amy_la_L)
...
p.norm_L <- normwave_L %>% ggplot(aes(Time, norm))+
  ...
  scale_alpha_manual(values=c(.17,.1))+
  # cluster
  annotate("rect", xmin=145, xmax=169, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=-13, xmax=27, ymin=-6, ymax=6.2, fill="white")+
  annotate("rect", xmin=-13, xmax=28, ymin=-2.5, ymax=2.5, fill="gray")+
  scale_color_manual(values=c("maroon3","maroon3","green4","green4",
                              "dodgerblue3","dodgerblue3"))+
  scale_fill_manual(values=c("maroon3","maroon3","green4","green4",
                              "dodgerblue3","dodgerblue3"))+
  ...
  scale_x_continuous(limits=c(-250,500), breaks = c(-200,-100,0,100,200,300,400,500))+
  xlab("Time (ms)")+ylab("Amplitude (SD)")+ 
  ggtitle("Left AMY, medial = 3, lateral = 5")+theme_classic()+
  theme(axis.line=element_line(linetype=1,color="black",size=.6))+
  theme(axis.ticks=element_line(color="black",size=.6,lineend = 12))+
  theme(axis.text = element_text(color = "black", size = rel(1.5)))+
  theme(axis.title = element_text(color = "black", size = 18))+
...
wave_amy_me_R <- wave_amy_me_R %>% mutate(subdivision = "Medial")
wave_amy_la_R <- wave_amy_la_R %>% mutate(subdivision = "Lateral")
normwave_R <- rbind(normwave_amy_R, wave_amy_me_R, wave_amy_la_R)
...
p.norm_R <- normwave_R %>% ggplot(aes(Time, norm))+
  ...
  scale_alpha_manual(values=c(.17,.1))+
  # FDR
  # annotate("rect", xmin=55, xmax=93, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=193, xmax=210, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  # annotate("rect", xmin=57, xmax=113, ymin=5.5, ymax=5.8, fill="green4")+
  # annotate("rect", xmin=195, xmax=217, ymin=5.5, ymax=5.8, fill="green4")+
  # annotate("rect", xmin=328, xmax=355, ymin=5.5, ymax=5.8, fill="green4")+
  # cluster
  annotate("rect", xmin=51, xmax=121, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  annotate("rect", xmin=189, xmax=280, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  annotate("rect", xmin=324, xmax=355, ymin=5.9, ymax=6.2, fill="dodgerblue3")+
  annotate("rect", xmin=53, xmax=124, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=190, xmax=242, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=324, xmax=359, ymin=5.5, ymax=5.8, fill="green4")+
  annotate("rect", xmin=400, xmax=448, ymin=5.1, ymax=5.4, fill="maroon3")+
  ...
  scale_x_continuous(limits=c(-250,500), breaks = c(-200,-100,0,100,200,300,400,500))+
  xlab("Time (ms)")+ylab("Amplitude (SD)")+ 
  ggtitle("Right AMY, medial = 15, lateral = 7")+theme_classic()+
  theme(axis.line=element_line(linetype=1,color="black",size=.6))+
  theme(axis.ticks=element_line(color="black",size=.6,lineend = 12))+
  theme(axis.text = element_text(color = "black", size = rel(1.5)))+
  theme(axis.title = element_text(color = "black", size = 18))+
...
figDir = "/Users/xianqliu/Library/CloudStorage/OneDrive-UniversityofIowa/1_TMS_iEEG/1_Figures"
setwd(figDir)
filename <- "iTEP_L-DLPFC_AMY_2hp_detrend500.pdf"
...
figDir = "/Users/xianqliu/Library/CloudStorage/OneDrive-UniversityofIowa/1_TMS_iEEG/1_Figures"
setwd(figDir)
filename <- "iTEP_L-DLPFC_AMY_2hp_detrend500_cluster.pdf"
pdf(file = filename, height = 4.4, width = 5.8)
p.components_amy
p.norm_bi
p.norm_L
...
```{r P70 range}
ptp1_amy <- ptp1_amy %>% mutate(Subregion = "Whole", n = 30)
ptp1_amy_me <- ptp1_amy_me %>% mutate(Subregion = "Medial", n = 18)
ptp1_amy_la <- ptp1_amy_la %>% mutate(Subregion = "Lateral", n = 12)
ptp1_all <- rbind(ptp1_amy, ptp1_amy_me, ptp1_amy_la)
ptp1_all$Subregion <- factor(ptp1_all$Subregion, levels = c("Whole", "Medial", "Lateral"))

p.ptp1 <- ptp1_all %>% 
  group_by(Subregion, Condition) %>% 
  summarise(
    mean = mean(range1),
    sd = sd(range1),
    n = mean(n)
  ...
  mutate(se = sd/sqrt(n)) %>% 
  ggplot(aes(x=Subregion, y=mean, fill = Subregion, alpha = Condition))+
  ...
  geom_signif(y_position=9, xmin=c(0.8), xmax=c(1.2), annotation=c("***"),
              tip_length=0, size=1, textsize = 8, vjust = 0.3)+
  geom_signif(y_position=10, xmin=c(1.8), xmax=c(2.2), annotation=c("**"),
              tip_length=0, size=1, textsize = 8, vjust = 0.3)+
  geom_signif(y_position=8, xmin=c(2.8), xmax=c(3.2), annotation=c("*"),
              tip_length=0, size=1, textsize = 8, vjust = 0.3)+
  scale_alpha_manual(values=c(0.9,0.4))+
  scale_fill_manual(values=c("dodgerblue3","green4","maroon3"))+
  ylim(-0.5,14.5)+
  ylab("Range (SD)")+xlab(NULL)+theme_classic()+
  theme(axis.line=element_line(linetype=1,color="black",size=.6))+
  theme(axis.ticks=element_line(color="black",size=.6,lineend = 12))+
  theme(axis.text = element_text(color = "black", size = rel(1.5)))+
  theme(axis.title = element_text(color = "black", size = 18))+
...
```{r N200 range}
ptp2_amy <- ptp2_amy %>% mutate(Subregion = "Whole", n = 30)
ptp2_amy_me <- ptp2_amy_me %>% mutate(Subregion = "Medial", n = 18)
ptp2_amy_la <- ptp2_amy_la %>% mutate(Subregion = "Lateral", n = 12)
ptp2_all <- rbind(ptp2_amy, ptp2_amy_me, ptp2_amy_la)
ptp2_all$Subregion <- factor(ptp2_all$Subregion, levels = c("Whole", "Medial", "Lateral"))
...
```{r P300 range}
ptp3_amy <- ptp3_amy %>% mutate(Subregion = "Whole", n = 30)
ptp3_amy_me <- ptp3_amy_me %>% mutate(Subregion = "Medial", n = 18)
ptp3_amy_la <- ptp3_amy_la %>% mutate(Subregion = "Lateral", n = 12)
ptp3_all <- rbind(ptp3_amy, ptp3_amy_me, ptp3_amy_la)
ptp3_all$Subregion <- factor(ptp3_all$Subregion, levels = c("Whole", "Medial", "Lateral"))
...
p.ptp3 <- ptp3_all %>% 
  ...
  geom_hline(yintercept=0, size = .4, linetype = "dashed")+
  # geom_boxplot(col = "black", size = 1, outlier.alpha = 1, width = 0.5, position = position_dodge(width = 0.7))+
  geom_signif(y_position=12, xmin=c(0.8), xmax=c(1.2), annotation=c("n.s."),
              tip_length=0, size=1, textsize = 6, vjust = -0.3)+
  geom_signif(y_position=14, xmin=c(1.8), xmax=c(2.2), annotation=c("n.s."),
              tip_length=0, size=1, textsize = 6, vjust = -0.3)+
  geom_signif(y_position=10, xmin=c(2.8), xmax=c(3.2), annotation=c("n.s."),
              tip_length=0, size=1, textsize = 6, vjust = -0.3)+
  scale_alpha_manual(values=c(0.9,0.4))+
...
setwd(figDir)
# Save pdf
filename <- "iTEP_L-DLPFC_AMY_range.pdf"
pdf(file = filename, height = 4.5, width = 10.5)
p.ptp1 | p.ptp2 | p.ptp3
dev.off()
```
...
```{r N/P70 left}
range_ptp1_amy_L <- ptp1_amy_L %>% group_by(Condition) %>%
